...
class InitCorpus(object):
    def __init__(self, table_name):
        ...
        stoplist = set("for a of the and to in is my you i with for an in that this it have me just when be it's cant im amp at on 3 http https & * ; ... # | - ! ? / , : rt . https://t.co co are th if he we his him has".split())
...
# model = models.wrappers.LdaMallet(mallet_path, corpus, num_topics=50, id2word=corpus.dictionary)
model = models.LdaModel(corpus, num_topics=50, id2word=corpus.dictionary)
# ...
